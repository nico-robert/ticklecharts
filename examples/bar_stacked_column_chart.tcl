...
$chart AddBarSeries -name "Email" \
               -stack "Ad" \
               -data [list {120 132 101 134 90 230 210}] \
               -emphasis {focus "series"}
               
$chart AddBarSeries -name "Union Ads" \
               -stack "Ad" \
               -data [list {220 182 191 234 290 330 310}] \
               -emphasis {focus "series"}
               
$chart AddBarSeries -name "Video Ads" \
               -stack "Ad" \
...
$chart AddBarSeries -name "Google" \
               -stack "Search Engine" \
               -data [list {120 132 101 134 290 230 220}] \
               -emphasis {focus "series"}
               
$chart AddBarSeries -name "Bing" \
               -stack "Search Engine" \
               -data [list {60 72 71 74 190 130 110}] \
               -emphasis {focus "series"}
               
$chart AddBarSeries -name "Others" \
               -stack "Search Engine" \
