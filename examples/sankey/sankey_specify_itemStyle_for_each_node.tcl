...
$chart Add "sankeySeries" -bottom 25 -left 50 -top 20 -right 150 \
                          -data {
                              ...
                              {name "SuperiorCard" itemStyle {color "rgba(128,155,72,1)" borderColor "rgba(128,155,72,1)"}}
                              ...
                              {name "Vista" itemStyle {color "rgba(106,82,134,1)" borderColor "rgba(106,82,134,1)"}}
                              ...
                              {name "ColonialVoice" itemStyle {color "rgba(64,105,157,1)" borderColor "rgba(64,105,157,1)"}}
                              ...
                              {name "Distinguish" itemStyle {color "rgba(159,65,62,1)" borderColor "rgba(159,65,62,1)"}}
...
$chart Render -outfile [file join $dirname $fbasename.html] -title $fbasename -width 1900px -height 1500px
